...
; carriage return (ASCII code 0Dh) positions the cursor to the left side 
;of the current line of characters
; line feed (ASCII code 0Ah) moves the cursor down one line on the output 
;device.
.CODE
ProgramStart:
 mov ax,@data
